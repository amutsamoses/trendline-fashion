// TrendLine Fashion - Main JavaScript
...
document.addEventListener('DOMContentLoaded', function() {
    ...
    // Collection cards animation on scroll
    ...
    // Observe collection cards and gallery items
    const animatedElements = document.querySelectorAll('.collection-card, .gallery-item, .feature-box');
